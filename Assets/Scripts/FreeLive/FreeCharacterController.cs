...
public class FreeCharacterController : MonoBehaviour, IDragHandler, IBeginDragHandler, IPointerClickHandler
{
    ...
    {
        if (!FreeLiveController.executingSkills)
        {
            FreeLiveController.selectedcharacter = id;
